...
var oErr_win5 = null;function PSwarning_win5(msg)
{
msg = PSmessageSubst_win5(msg, PSwarning_win5.arguments, 1);if (isFModeLayout()) 
 psConfirmFluid("Warning", msg, "", "", "", "");else
 psAlert(msg, "Warning");}

function PSdeferWarning_win5(msg)
{
sDefMsg_win5 = PSmessageSubst_win5(msg, PSdeferWarning_win5.arguments, 1);bDefWarning_win5 = true;}

function PSerror_win5(obj, msg)
{
if (bReset_win5)
{
 resetChange(obj); bReset_win5 = false;}
else
{
 obj.PSsaveclass = obj.className; obj.className = "PSERROR";}
msg = PSmessageSubst_win5(msg, PSerror_win5.arguments, 2);if (isFModeLayout()) 
 psConfirmFluid("Error", msg, "", "", "", "");else
 psAlert(msg, "Error");oErr_win5=obj;}

function PSdeferError_win5(obj, msg)
{
sDefMsg_win5 = PSmessageSubst_win5(msg, PSdeferError_win5.arguments, 2);oDefErr_win5=obj;bDefWarning_win5 = false; }

function PSshowDeferredMsg_win5()
{
if (sDefMsg_win5=="")return;if (bDefWarning_win5)
 PSwarning_win5(sDefMsg_win5);else
 PSerror_win5(oDefErr_win5, sDefMsg_win5);sDefMsg_win5 = "";oDefErr_win5 = null; }

function PSclearError_win5(obj)
{
if (obj == oDefErr_win5)
{
 sDefMsg_win5 = "";  oDefErr_win5 = null; }
}

function PSmessageSubst_win5(msg, parms, startparm)
{
...
function FindString_win5(obj)
{
var s = prompt("Enter search string:","");if (s == null || s == "")
 return false;obj.value = s;return true;}

function DeleteCheck_win5(form,name)
{


var deleteAction = 'oParentWin.aAction_win5(oParentWin.document.win5' + ',"' + name + '")';if (typeof CKEDITOR != 'undefined') UpdateEditorLinkedField();psConfirm2("Delete Confirmation", "Delete current/selected rows from this page?  The delete will occur when the transaction is saved.", "OKCancel", " ", deleteAction);}

function DeleteCheck2_win5(name)
{
gFocusObj = document.getElementById(name);if (arguments.length == 0) 
 return confirm("Delete current/selected rows from this page?  The delete will occur when the transaction is saved.");else if(arguments.length ==1 && (typeof event != 'undefined') && event.altKey && bAccessibility_win5 && !isFModeLayout())
 return confirm("Delete current/selected rows from this page?  The delete will occur when the transaction is saved.");else 
 {
 if (bAccessibility_win5 && !PT_isModalDialogPresent()) 
 var deleteAction = 'submitAction_win5(document.win5' + ',"' + arguments[0] + '")'; else 
 var deleteAction = 'oParentWin.aAction_win5(oParentWin.document.win5' + ',"' + arguments[0] + '")';     if (isFModeLayout())
...
var oChange_win5 = null;var oDefErr_win5 = null;var sDefMsg_win5 = "";var bDefWarn_win5; var oKillFocus_win5 = null;var oTargetFocus_win5 = null;var bReset_win5 = false;function initVars_win5()
{


oChange_win5 = null;oDefErr_win5 = null;sDefMsg_win5 = "";bDefWarn_win5 = false; oKillFocus_win5 = null;oTargetFocus_win5 = null;bReset_win5 = false;nLastKey_win5 = 0;}
function moveFocus_win5(killobj)
{
if (typeof popupObj_win5 != "undefined" && popupObj_win5 && popupObj_win5.isShown) 
 ptCommonObj2.tryFocus0(popupObj_win5.popupFocus);if (oErr_win5!=null)
{
 oKillFocus_win5 = killobj; oTargetFocus_win5 = oErr_win5; oErr_win5.focus(); oErr_win5 = null;}
}

function doFocus_win5(obj,bTabonly,bDef)
{
if (obj == null) return;if (isFModeLayout() && oChange_win5 != obj && (obj.type == "checkbox" || obj.type == "radio")) 
{
 var sScript = obj.getAttribute('onclick'); if (sScript && sScript.indexOf("submitAction_") != -1) {
 oChange_win5 = null; return; }
}


if (typeof gridRowSelRgbColor_win5 != "undefined") {
 var gridRowID = getGridRowID(obj);  if (gridRowID != null && gridRowID.length > 0 )
 HighLightTR(gridRowSelRgbColor_win5,'',gridRowID);}
...
if (window.focusHook)
 focusHook(obj);if (obj==oTargetFocus_win5)
{
 oTargetFocus_win5 = null; oKillFocus_win5 = null; return;}


if (typeof dateBoxOpen != "undefined" && dateBoxOpen)
 closeCal2(obj);var nRCFLastKey = getLastKey_win5();if(!bTabonly || nRCFLastKey == "\t".charCodeAt(0))
{
 if(oChange_win5!=null && oChange_win5!=obj)
 {
 if (oChange_win5.form){
 oChange_win5.form.ICFocus.value=obj.id; oChange_win5.form.ICFocus.nRCFLastKey = nRCFLastKey; submitAction_win5(oChange_win5.form,oChange_win5.id); }
 else{
 if (document.getElementById(oChange_win5.id) && document.getElementById(oChange_win5.id).form ){
 document.getElementById(oChange_win5.id).form.ICFocus.value = obj.id; document.getElementById(oChange_win5.id).form.ICFocus.nRCFLastKey = nRCFLastKey; submitAction_win5(document.getElementById(oChange_win5.id).form,oChange_win5.id); }
 }

 oChange_win5 = null; }
 else if(bDef && oDefErr_win5!=null && oDefErr_win5!=obj)
 PSshowDeferredMsg_win5();}
moveFocus_win5(obj);}

function doFocusMac_win5(obj,bTabonly)
{
if (obj==oTargetFocus_win5)
{
 oTartgetFocus_win5 = null; oKillFocus_win5 = null; return;}


if (typeof dateBoxOpen != "undefined" && dateBoxOpen)
 closeCal2();document.win5.ICFocus.value = obj.id;if(oDefErr_win5!=null && oDefErr_win5!=obj)
 PSshowDeferredMsg_win5();moveFocus_win5(obj);}

function doReqField_win5(obj, bserver, bnumeric)
{

if (oKillFocus_win5==obj)
...
{
 if (bserver)
 oChange_win5=obj; else
 PSdeferError(obj, "Field is required."); }
}

function addchg_win5(obj,id) {
...
if (isFModeLayout() && obj.type == "select-one")
 ...
 if (typeof document.chgFldArr_win5 != "undefined" && document.chgFldArr_win5 != "undefined")
 {
 var bFound = false; for (var i = 0; i < document.chgFldArr_win5.length; i++) {
 if (document.chgFldArr_win5[i] == id) {
 bFound = true; continue; }
 }
 if (!bFound) 
 document.chgFldArr_win5.push(id); }
 } catch (e) {}
}

function doEdits_win5(obj,sType,bHist,bEffdtSub,bDate,bYN,bUCase,bImmed, re)
{

gFocusObj=obj;if(sDefMsg_win5!="")
{
 PSshowDeferredMsg_win5(); return false;}


if(oChange_win5 != null)
{
 submitAction_win5(obj.form,obj.id); return true;}
...
var bErr = false; if(sType!='') bErr = checkType_win5(obj, sType, re);if(!bErr && bHist=='Y') bErr = historyUpdated_win5(obj);if(!bErr && bEffdtSub=='Y') bErr =subscrollUpdated_win5(obj);if(!bErr && bDate=='Y') bErr = isReasonableDate_win5(obj);if(!bErr && bYN=='Y') bErr = isYN_win5(obj);if (bErr && bImmed=='Y') PSshowDeferredMsg_win5();return true;}
...
function historyUpdated_win5(obj)
{
if (!isChanged(obj))
 return false;PSdeferError_win5(obj, "Cannot change current or history records unless in Correction mode.");bReset_win5 = true;return true;}

function subscrollUpdated_win5(obj)
{
if (!isChanged(obj))
 return false;PSdeferError_win5(obj, "Cannot change key field with effective dated subordinate data unless in Correction mode.");bReset_win5 = true;return true;}



function isReasonableDate_win5(obj)
{
if(obj.type == "select-one") obj = obj.options[obj.selectedIndex];var dateval = new Date(obj.value);var now = new Date();var diff = new Date(Math.abs(now.getTime() - dateval.getTime()));if (diff.getMonth > 0)
 ...
 PSdeferWarning_win5("Warning -- date out of range.");return false;}


function isYN_win5(obj)
{
 ...
 val = obj.value;if (val != 'Y' && val != 'N')
{
 ...
 PSdeferError_win5(obj, "Value must either be Y for Yes or N for No."); return true;}
return false;}


function isNumOnly_win5(obj)
{
var val = obj.value;if (val == '') return false;if (val.search(/^ *\d* *$/) != 0)
{
 
 PSdeferError_win5(obj, "Numeric Only field format error.  Please reenter."); return true;}
return false;}

function isNumeric_win5(obj,fmt,re)
{
var val = obj.value;if (val == '') return false;if (val.search(re) != 0)
{
 
 PSdeferError_win5(obj, "Number field format error. This field accepts %1 number. %2", fmt); return true;}
return false;}

function isTime_win5(obj,fmt)
{
var val = obj.value;if (val == '') return false;if (!checkTime(val,fmt))
{
 
 PSdeferError_win5(obj, "Time field format error.  Please re-enter using the proper format."); return true;}
return false;}

function isDateTime_win5(obj,fmt)
{
var val = obj.value;if (val == '') return false;var newval = checkDateTime(val,fmt);if (newval == "")
{
 
 PSdeferError_win5(obj, "Datetime field format error.  Please reenter using the proper format."); return true;}
obj.value = newval;return false;}

function isDate_win5(obj,fmt)
{
var val = obj.value;if (val == '') return false;var dt = getDate(val,fmt,szCalendarType);if (dt==null)
{
 PSdeferError_win5(obj, "The system does not understand the date you entered.");  return true;}
obj.value = pt_formatDate(dt, fmt, szCalendarType);return false;}

function checkType_win5(obj,sType,re)
{
var cType = sType.substring(0, 1);var sFmt = sType.substring(1);switch(cType)
{
case 'N': return isNumOnly_win5(obj);case 'S': return isNumeric_win5(obj,sFmt,re);case 'D': return isDate_win5(obj,sFmt);case 'T': return isTime_win5(obj,sFmt);case 'X': return isDateTime_win5(obj,sFmt);}
return false;}
...
function setSelectElemOptions_win5()
{

var bIE = (navigator.userAgent.toLowerCase().indexOf('msie') || navigator.userAgent.toLowerCase().indexOf('trident'));if (typeof selectElemOptions_win5 != "undefined")
 {
 for (var i = 0; i < selectElemOptions_win5.length; i++)
 {
 var selectElem = document.forms['win5'].elements[selectElemOptions_win5[i][0]]; if (selectElem == null)
 continue; if (selectElem.options != null)
 var curLen = selectElem.options.length; else
 var curLen = 0; var options = optionsArray_win5[selectElemOptions_win5[i][1]];     var selected = selectElemOptions_win5[i][2]; var erroraccess = selectElemOptions_win5[i][3]; if (typeof options == "undefined" || options==null || selected == null)
